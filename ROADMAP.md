...
- [ ] Audio support in the package: WAV loading, tap onset detection, trim
- [ ] A written capture protocol (materials, tap count, mounting, distance,
      device notes) — reproducibility lives in the protocol
- [ ] Pilot dataset: ≥5 materials × ≥30 taps × ≥2 recording devices
- [ ] `resdb benchmark`: evaluation that splits by **device/session**, never
      randomly
